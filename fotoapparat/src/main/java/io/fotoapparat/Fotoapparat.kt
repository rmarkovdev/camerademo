...
import io.fotoapparat.routine.focus.attachRecordingCamera
...
@JvmOverloads constructor(
    ...
    fun attachRecordingCamera(mediaRecorder: MediaRecorder, attached: () -> Unit) {
        executor.execute(Operation(cancellable = true) {
            device.attachRecordingCamera(
    ...
    fun lock() {
        device.getSelectedCamera().lock()
    }

    fun unlock() {
        device.getSelectedCamera().unlock()
    }
